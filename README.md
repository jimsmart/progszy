...
#### Response Headers
 ...
 - `X-Cache-Fetched` (for cache misses only) indicates when the upstream response completed (RFC3339 format).
 - `X-Cache-Fresh` indicates when the content was originally cached (RFC3339 format).
