...
For example, request responses for `http://www.example.com/index.htm` and `http://foo.bar.example.com/index.htm` will both get cached in the same database, which would have a resulting filename like `example.com-2020-03-20-1640.sqlite`.
